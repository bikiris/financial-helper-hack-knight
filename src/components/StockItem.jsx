...
const StockItem = ({ symbol, name, stockPrice, currentValue, quantity, previousClose, purchasePrice }) => {
  ...
  return (
    <div 
      className={`my-4 md:m-[0px] p-4 rounded-lg shadow-sm bg-gray-100 dark:bg-gray-800 ${getHoverBgColorClass()} cursor-pointer transition-all duration-200 ${isExpanded ? "" :"self-start"}`}
